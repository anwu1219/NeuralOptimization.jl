...
class_string = "MNIST"
network_files = ["/barrett/scratch/haozewu/Optimization/NeuralOptimization.jl/Networks/MNIST/mnist10x10.nnet"]
input_files =["/barrett/scratch/haozewu/Optimization/NeuralOptimization.jl/Datasets/MNIST/MNISTlabel_0_index_0_.npy"]
objective_one = NeuralOptimization.LinearObjective([1.0, -1.0], [2, 1]) # objective is to just maximize the first output
...
deltas = [.001 * ones(784)] # both hypercubes for now
maximize = true
output_file_benchmark = "/barrett/scratch/haozewu/Optimization/NeuralOptimization.jl/BenchmarkOutput/benchmark_files/test1_benchmark.csv"
...
output_file_optimizers = "/barrett/scratch/haozewu/Optimization/NeuralOptimization.jl/BenchmarkOutput/benchmark_files/test1_optimizers.csv"
append_to_file = false
optimizers = [
              LBFGS_optimizer,
              PGD_optimizer,
...
output_file_query ="/barrett/scratch/haozewu/Optimization/NeuralOptimization.jl/BenchmarkOutput/benchmark_files/benchmark_set_test1.csv"
